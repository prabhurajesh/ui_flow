...
import 'package:ui_flow/screens/dashboard.dart';
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: DropdownButton(
                        ...
                        items: List<DropdownMenuItem<Merchant>>.generate(
                            widget.user.merchants.length,
                            (index) => DropdownMenuItem(
                                  child: Text(widget.user.merchants[index].id),
                                  value: widget.user.merchants[index],
                                )),
                        value: merchant, //merchant.id,
                        onChanged: widget.user.merchants.length > 0
                            ? (val) {
                                print(val);
                                setState(() {
                                  merchant = val;
